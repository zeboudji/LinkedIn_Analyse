...
def generate_performance_graphs(excel_data):
    try:
        ...
        # **NOUVEAUX GRAPHIQUES**
        # Top 10 des meilleurs posts par interactions
        top_posts = meilleurs_posts_df.nlargest(10, 'Interactions')
        fig_top_posts = px.bar(top_posts, x='Date de publication', y='Interactions',
                               title="Top 10 des Meilleurs Posts par Interactions",
                               labels={'Interactions': 'Interactions'},
                               template='plotly_dark')

        # Histogramme des interactions pour visualiser la distribution
        fig_interactions_hist = px.histogram(meilleurs_posts_df, x='Interactions',
                                             title="Distribution des Interactions",
        ...
        return (fig_posts, fig_impressions, fig_interactions, fig_engagement, fig_subscribers,
                ...
                fig_top_posts, fig_interactions_hist)
